...
// @ts-ignore
export const CuratorProfileScreen: FC<StackScreenProps<AppStackScreenProps, "CuratorProfile">> =
  observer(function CuratorProfileScreen({ route }) {
        ...
        <BottomSheet show={showUserListModal} onClose={onCloseUserListModal}>
          <View padding-8>
            ...
            <View marginT-15 style={$mapContainer}>
              <CardList data={selectedListItem?.cards || []} isFeed={false} isUserList hideRemove />
            </View>
          </View>
        </BottomSheet>
      </>
